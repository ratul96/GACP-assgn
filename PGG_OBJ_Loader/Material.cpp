...
void Material::Apply()
{
	...
	glUniform1i(glGetUniformLocation(_shaderProgram, "irrMap"), 0);
	glUniform1i(glGetUniformLocation(_shaderProgram, "prefilMap"), 0);
	glUniform1i(glGetUniformLocation(_shaderProgram, "brdfTex"), 2);
